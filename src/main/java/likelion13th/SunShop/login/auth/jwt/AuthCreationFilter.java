...
// "/user/reissue" 요청에 대해서만 동작하는 필터.
// 만료된 Access Token에서도 providerId(subject)를 추출하여,
// providerId가 존재할 경우, 익명 권한(ROLE_ANONYMOUS)만 부여한
// PreAuthenticatedAuthenticationToken을 생성해 SecurityContext에 저장.
// 즉, 토큰이 만료된 상황에서도 재발급(reissue)을 위한 최소한의 인증 정보를 유지하도록 처리함.
